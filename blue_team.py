...
class ClientHandle:
    ...
    def create_object_from_dict(self, all_data, client_team_name):
        ...
        enemy_gate.ball = all_data["yellow_gate"]["ball"]
        enemy_gate.pos_x = all_data["yellow_gate"]["pos_x"]
        enemy_gate.pos_y = all_data["yellow_gate"]["pos_y"]
    ...
    def create_dict_from_objects(self, all_data, client_team, client_team_name, enemy_gate):
        ...
        all_data["yellow_gate"]["ball"] = enemy_gate.ball
    ...
    def run(self):
        while True:
            ...
            client_team_name = "blue_team"
            client_team_color = "blue"
